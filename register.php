...
<head>
    ...
    <title>I-Trashy - Registrasi</title>
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 bg-gray-50 flex flex-col justify-center p-8">
            <div class="flex justify-evenly mb-8">
                <a href="registrasi.php" class="bg-blue-600 text-white px-8 py-2 rounded-lg">Daftar</a>
                <a href="login.php" class="bg-white text-gray-500 px-8 py-2 rounded-lg">Login</a>
            </div>            
            <div class="max-w-md mx-auto">
                <h2 class="text-2xl font-bold mb-4">Hello!<br>
                    <span class="text-base font-normal">Yuk, kelola sampahmu bersama kami</span>
                </h2>
                <form>
                    <div class="mb-4">
                        <input type="text" placeholder="Nama Lengkap" required class="w-full px-4 py-2 rounded-lg border border-gray-300">
                    </div>
                    <div class="mb-4">
                        <input type="tel" placeholder="No. Handphone" required class="w-full px-4 py-2 rounded-lg border border-gray-300">
                    </div>
                    <div class="mb-4">
                    ...
                    <button type="submit" formaction="index.html" class="w-full py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-500 transition">Daftar</button>
                </form>
            </div>
        </div>
    </div>
